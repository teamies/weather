...
class ChartPaint extends CustomPainter {
  ...
  final ylabelStyle = appStyleText.textStyle14;
  final xLabelStyle = appStyleText.textStyle14b;
  ...
  //_draw x Labels
  final c1 = Offset(c.dx, top - border*4.5);
  ...
  void _drawDataPoints(
    ...
    points.forEach((dp) {
      canvas.drawCircle(dp, radius/2.0, dotPaintFill);
      canvas.drawCircle(dp, radius/2.0, linePaint);
    });
  }
